...
! function(t) {
	...
	e = "", u = (u = void 0 === u ? {} : u).insertAt, e && "undefined" != typeof document && (n = document.head || document.getElementsByTagName("head")[0], (l = document.createElement("style")).type = "text/css", "top" === u && n.firstChild ? n.insertBefore(l, n.firstChild) : n.appendChild(l), l.styleSheet ? l.styleSheet.cssText = e : l.appendChild(document.createTextNode(e)));
	var n, l, u = function(t, e, n) {
	...
	function x(e, t) {
		return 1 === arguments.length ? function(t) {
			return x(e, t)
		} : v(decodeURIComponent(t.getAttribute("href").split("?")[0])) === v(decodeURIComponent(e))
	}
	u(w, [{
		key: "toJSON",
		value: function() {
			if (this.hyperlink) return {
				...
				isExternal: "_blank" === this.hyperlink.getAttribute("target")
			}
		}
	}]);
	var y = w;
	...
	function w(t) {
		...
		t && (this.chapter = (e = p(e = t, "div > ul > li"), c("p", e)), this.hyperlink = m(t))
	}
	var b = function() {
			return '<div class="' + h + '"></div>'
		},
		k = function(t, e) {
			a = e, r = t.route.path, o = {}, ["previousText", "nextText"].forEach(function(n) {
				var i = a[n];
				"string" == typeof i ? o[n] = i : Object.keys(i).some(function(t) {
	...
	window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function(t, e) {
		...
		function i() {
			var t = c("." + h);
			t && (t.innerHTML = k(function(t, e) {
				e = e.crossChapter;
				try {
					var n = t.router.toURL(t.route.path),
						i = g(c.all(".sidebar-nav li a")).filter(function(t) {
							return !s(t, ".section-link")
						}),
						a = i.find(x(n)),
						r = g((p(a, "ul") || {}).children).filter(function(t) {
							return "LI" === t.tagName.toUpperCase()
						}),
						o = e ? i.findIndex(x(n)) : r.findIndex(function(t) {
							t = m(t);
							return t && x(n, t)
						}),
						l = e ? i : r;
